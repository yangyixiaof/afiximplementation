...
/**
 * This simple example application builds a WALA IR and fires off a PDF viewer
 * to visualize a DOT representation.
 */
public class AFixWalaIR {

	final public static String PDF_FILE = "ir.pdf";

	/**
	 * Usage: PDFWalaIR -appJar [jar file name] -sig [method signature] The "jar
	...
	public static Process run(String appJar, String methodSig) throws IOException {
		try {
			...
			// Build an AnalysisScope which represents the set of classes to
			// analyze. In particular,
			// we will analyze the contents of the appJar jar file and the Java
			// standard libraries.
			AnalysisScope scope = AnalysisScopeReader.makeJavaBinaryAnalysisScope(appJar,
					(new FileProvider()).getFile(CallGraphTestUtil.REGRESSION_EXCLUSIONS));

			// Build a class hierarchy representing all classes to analyze. This
			// step will read the class
			...
			// Resolve the method name into the IMethod, the canonical
			// representation of the method information.
